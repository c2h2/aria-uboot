...
static struct module_pin_mux aria_sound_pin_mux[] = {
        {OFFSET(emu1), (MODE(7) | PULLUDEN)},      /* GPIO0_7 */
        {-1},
};
...
static struct module_pin_mux itc_mii1_pin_mux[] = {
        {OFFSET(mii1_col), MODE(0) },       /* MII1_RXERR */
        {OFFSET(mii1_crs), MODE(0) },       /* MII1_RXERR */
        {OFFSET(mii1_rxerr), MODE(0) | RXACTIVE},       /* MII1_RXERR */
        {OFFSET(mii1_txen), MODE(0)},                   /* MII1_TXEN */
        {OFFSET(mii1_rxdv), MODE(0) | RXACTIVE},        /* MII1_RXDV */
        {OFFSET(mii1_txd3), MODE(0)},                   /* MII1_TXD3 */
...
void enable_aria_sound_pin_mux(void){
	configure_module_pin_mux(aria_sound_pin_mux);
}
